...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.AudioTypes, Value: "mp3,flac,ogg,m4a,wav,opus,wma,mpa,aac", Type: conf.TypeText, Group: model.PREVIEW, Flag: model.PRIVATE},
		{Key: conf.VideoTypes, Value: "mp4,mkv,avi,mov,rmvb,webm,flv,ts,wmv,m3u8", Type: conf.TypeText, Group: model.PREVIEW, Flag: model.PRIVATE},
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.SearchIndex, Value: "none", Type: conf.TypeSelect, Options: "none", Group: model.INDEX},
